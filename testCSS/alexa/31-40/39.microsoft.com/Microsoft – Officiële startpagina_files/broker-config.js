...
COMSCORE.SiteRecruit.Broker.config = {
  ...
  {m: '//[\\w\\.-]+/en-(au|ca|eg|hk|in|ie|my|nz|pk|ph|sa|sg|za|gb|us)/learning/.*', c: 'inv_c_Learning-2342.js', f: 0.2, p: 0  }
  ,{m: '//[\\w\\.-]+/(en-us/default.aspx|en-us/?$|en-us?$)', c: 'inv_c_p246609455-1255.js', f: 0.1863, p: 1  }
  ,{m: '//[\\w\\.-]+/(en-us/default.aspx|en-us/?$|en-us?$)', c: 'inv_c_p38796305-1255-M.js', f: 0.05, p: 2 , prereqs:{content:[],cookie:[{'name':'srMOB','value':'1'}]}}
  
	,{m: '//[\\w\\.-]+/(en-us/download)|(download/(en/|.*?displaylang=en))', c: 'inv_c_p246609455-1345.js', f: 0.0275, p: 1 }
