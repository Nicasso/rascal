...
public class ASTConverter extends JavaToRascalConverter {
	/*
	 * TODO: Type parameters need to come out of annotations calls may need to
	 * be broken up into superconstructor, constructor, supermethod, method
	 * calls or separate them in bindings
	 */
	...
	public boolean visit(Assignment node) {
		...
		ownValue = constructExpressionNode("assignment", leftSide, values.string(node.getOperator().toString()),
				rightSide);
	...
	public boolean visit(BreakStatement node) {
		IValue label = node.getLabel() == null ? values.string("")
				: values.string(node.getLabel().getFullyQualifiedName());
	...
	public boolean visit(ClassInstanceCreation node) {
		...
		ownValue = constructExpressionNode("newObject", expression, type, arguments.asList(),
	...
	public boolean visit(CompilationUnit node) {
		...
		ownValue = constructDeclarationNode("compilationUnit", packageOfUnit, imports.asList(),
				typeDeclarations.asList());
		return false;
	}
	...
	public boolean visit(EnumDeclaration node) {
		...
		ownValue = constructDeclarationNode("enum", name, implementedInterfaces.asList(), enumConstants.asList(),
				bodyDeclarations.asList());
		setAnnotation("modifiers", extendedModifiers);
		return false;
	}
	...
	public boolean visit(MethodDeclaration node) {
		...
		ownValue = constructDeclarationNode(constructorName, returnType, name, parameters.asList(),
				possibleExceptions.asList(), body);
		setAnnotation("modifiers", extendedModifiers);
	...
	public boolean visit(SingleVariableDeclaration node) {
		...
		ownValue = constructDeclarationNode("parameter", type, name, values.integer(node.getExtraDimensions()),
				initializer);
	...
	public boolean visit(TypeDeclaration node) {
		...
		ownValue = constructDeclarationNode(objectType, name, extendsClass.asList(), implementsInterfaces.asList(),
				bodyDeclarations.asList());
		setAnnotation("modifiers", extendedModifiers);
		setAnnotation("typeParameters", genericTypes);
		return false;
	...
	public boolean visit(WildcardType node) {
		// FIXME: upperbound/lowerbound that should have been type annotation
		// are replaced by TypeSymbol
		IValue type = null;
